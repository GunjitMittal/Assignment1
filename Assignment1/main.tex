...
\end{table}
\par
The distance of ship A from light house ($x$) is given by $60 \times \tan(60\degree) = 60 \times \sqrt{3} $
\newline
The distance of ship B from light house ($y$) is given by $60 \times \tan(45\degree) = 60 $
\newline
...
\newline
$\therefore$ Distance between ships A and B (answer) $= x+y = 60 \times \sqrt3 + 60 = 103.92 + 60 = 163.92$
\newline 
$\therefore$ answer $= 164 $
\end{document}