...
\begin{lstlisting}
https://github.com/GunjitMittal/Assignment1/tree/main/Assignment1/codes
\end{lstlisting}
Download all latex codes from 
\begin{lstlisting}
https://github.com/GunjitMittal/Assignment1/tree/main/Assignment1
\end{lstlisting}
\section{Question}
...
\begin{table}[ht!]
    ...
    \hline
    Dist.\ of ship A from ship B & $d$ & {}?\\
    \hline
    \end{tabular}
\end{table}
\par
The distance of ship A from light house ($x$) is given by
\begin{equation}
    \label{eq:1.1}
    x = h ~\tan(\theta_1) 
\end{equation}
The distance of ship B from light house ($y$) is given by 
\begin{align}
    \label{eq:eq2}
    y = h ~\tan(\theta_2) 
\end{align}
...
\newline
$\therefore$ Distance between ships A and B (d) $=$
\begin{align} 
    &d = x+y \\
   & = h ~\tan(\theta_1) + h ~\tan(\theta_2) (\text{from}~\eqref{eq:1.1} \text{and}~\eqref{eq:eq2}) \\
   &= 60  \sqrt3 + 60 \\
   &= 103.92 + 60 = 163.92\\
   &\implies d = 164 
\end{align}
